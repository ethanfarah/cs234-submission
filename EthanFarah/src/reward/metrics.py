"""Task metrics: F1, EM, ROUGE computation."""
...
def compute_f1(prediction: str, ground_truth: str) -> float:
    ...
    if not pred_tokens and not gold_tokens:
        # Only treat as perfect match if both original strings were empty.
        # Two non-empty strings that normalize to empty (e.g. "!!!" vs "???")
        # should get F1=0, not 1.
...
def compute_task_score(llm_output: str, metadata: dict) -> float:
